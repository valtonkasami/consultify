...
export default function Home() {
  ...
  return (
    ...
    <div className='yoo max-sm:mb-10 mt-[75px] flex flex-col items-center justify-center space-y-5'>
      ...
      <h1 className='max-sm:mt-10 text-white text-5xl font-bold text-center max-sm:text-4xl'><span className='max-hero:hidden'>The Digital</span> Marketing Agency</h1>
